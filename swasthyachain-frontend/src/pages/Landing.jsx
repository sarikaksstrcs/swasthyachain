...
import { Shield, Lock, Brain, FileCheck, Users, Zap, Calendar, Clock } from 'lucide-react';
...
export const Landing = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Get instant notifications for appointments and health updates',
    },
  ];
  ...
  const howItWorks = [
    ...
    },
    {
      ...
      description: 'Securely store your health records with blockchain verification',
    },
    {
      step: '3',
      ...
      <div className="backdrop-blur-lg bg-blue-600 to-blue-800 text-white py-20">
        <div className="container mx-auto px-4 text-center ">
          ...
          <p className="text-lg mb-8 max-w-3xl mx-auto opacity-90">
            Secure medical records, smart appointments, AI-powered insights, and complete patient control - all in one platform
          </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Book appointments with your preferred doctors in seconds. View real-time availability, 
                  get instant confirmations, and manage your healthcare schedule all in one place.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Real-time availability for doctors</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700">Interactive calendar for doctors</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700">Automatic patient record linking</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl">
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Book Appointments</p>
                      <p className="text-sm text-gray-600">Find and schedule with doctors</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">See available time slots instantly</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-purple-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Doctors track all appointments</p>
                    </div>
                  </div>
                </div>
              </div>
