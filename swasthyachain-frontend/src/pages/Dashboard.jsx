    ...
    user?.role === "doctor"
      ...
      : [
          ...
          },
          {
            ...
            value: loading
              ? "..."
              : upcomingAppointments.length + todayAppointments.length,
            color: "bg-green-100 text-green-600",
            link: "/appointments",
          },
          {
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p
                                className={`text-sm text-${color}-600 font-medium mt-1`}
                              >
                    ...
                    {todayAppointments.map((appointment, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-medium capitalize ${statusColors[appointment.status] || "bg-gray-100 text-gray-700"}`}
                          >
                            {appointment.status}
                          </span>
                        </div>
